...
class ScheduleServiceTest {
    ...
    @Autowired
    ScheduleRepeatService scheduleRepeatService;
    @Autowired
    ...
    void 일정을_생성시_참가자를_함께_설정할_수_있다() {
        ...
        ScheduleDto scheduleDto = ScheduleDto.builder()
                ...
                .repeatType("매일")
                .members(List.of(member2.getId(), member3.getId()))
                .build();

        List<Long> schedule = scheduleRepeatService.saveRepeatSchedule(member.getId(), scheduleDto);
