...
public class AuthController implements AuthApi {
    ...
    @Override
    public ResponseEntity<MemberIdResponse> registerToEmail(EmailRequest request) {
        MemberIdResponse response = authService.registerToEmail(request.email(),
                request.password());
    ...
    @Override
    public ResponseEntity<MemberIdResponse> register(String provider, SocialRegisterRequest request) {
        MemberIdResponse response = authService.registerToOauth(
